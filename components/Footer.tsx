  ...
  return (
    <footer className="bg-pink-100 text-gray-700 py-10 w-full">
      <div className="w-full flex flex-col md:flex-row justify-between items-start px-6 md:px-12 gap-8">
        ...
        <div className="min-w-55">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            />
            <button className="px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white rounded-md transition-colors flex items-center justify-center">
              <ArrowRight size={20} />
            </button>
          </div>
        </div>
      ...
      <div className="mt-10 text-center text-gray-500 text-sm">
        © 2025 GGST Innovations. All Rights Reserved.
      </div>
    </footer>
  );
};
