...
const faqs = [
  ...
  { question: "What payment methods do you accept?", answer: "We accept all major credit cards, PayPal, and secure UPI payments. All transactions are encrypted for your royal security.", icon: <CreditCard size={20} className="text-pink-500" /> },
...
export default function FAQPage() {
  ...
  return (
    // THE NEW BACKGROUND COLOR GRADIENT
    <main className="min-h-screen bg-gradient-to-b from-pink-50 via-white to-pink-50 pb-20">
      ...
      <section className="pt-24 pb-12 px-6 text-center">
        ...
        <p className="mt-8 text-gray-500 font-medium tracking-wide max-w-xl mx-auto">
          Discover the artistry and policies behind our royal collections.
        </p>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 mt-24">
        <div className="p-12 rounded-[40px] bg-gradient-to-br from-pink-500 to-pink-700 text-white text-center relative overflow-hidden shadow-2xl">
          <div className="relative z-10">
            <h2 className="text-4xl font-bold mb-4">Still have questions?</h2>
            <p className="text-pink-100 mb-10 max-w-md mx-auto text-lg">Our royal support team is here to help you find the perfect piece.</p>
            <Link href="/contact">
              <button className="bg-white text-pink-600 px-10 py-4 rounded-full font-bold hover:scale-110 hover:shadow-xl transition-all duration-300">
                Contact Support
              </button>
            </Link>
          </div>
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-pink-400/20 rounded-full -ml-20 -mb-20 blur-3xl"></div>
        </div>
      </section>
    </main>
  );
