          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className={`w-full rounded-[14px] bg-[#FFE6F0] border px-4 py-2.5 text-sm placeholder:text-gray-400 focus:outline-none transition-all ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="space-y-1">
                <label className="text-[12.7px] font-normal text-[#555555] tracking-tight">Confirm *</label>
                <input
            ...
            <button type="submit" className="w-full rounded-full bg-[#E15483] text-white py-3 text-sm font-bold shadow-md hover:opacity-90 active:scale-[0.98] transition-all mt-2">
              Sign Up
            </button>

            <div className="w-full rounded-full border border-gray-300 bg-gray-50/50 py-2.5 text-sm font-semibold flex items-center justify-center gap-2 cursor-not-allowed select-none">
