...
const MOCK_PRODUCTS = [
  {
    ...
    price: 34.99,
    originalPrice: null,
    image: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?q=80&w=600&auto=format&fit=crop" // Placeholder
  },
  {
    id: 2,
  ...
  },
  {
    ...
    price: 64.99,
    originalPrice: null,
    image: "https://images.unsplash.com/photo-1599643478524-fb66f7ca065b?q=80&w=600&auto=format&fit=crop"
  }
];
        ...
        <aside className="w-full lg:w-64 flex-shrink-0 space-y-6 lg:sticky lg:top-32 h-fit">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="text-xs text-pink-500 font-medium hover:underline">Clear</button>
            </div>
            <ul className="space-y-3 text-sm">
              <li className="flex justify-between items-center text-pink-500 font-medium cursor-pointer">
                All Products <span className="bg-pink-100 text-pink-600 px-2 py-0.5 rounded-full text-xs">156</span>
              </li>
              {['Bracelets', 'Necklaces', 'Earrings', 'Rings', 'Accessories'].map((cat) => (
                <li key={cat} className="flex justify-between items-center text-gray-600 hover:text-pink-500 cursor-pointer transition-colors">
                  {cat} <span className="bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full text-xs">24</span>
                </li>
              ))}
            </ul>
          </div>
