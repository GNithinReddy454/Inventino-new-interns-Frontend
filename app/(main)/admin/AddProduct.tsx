    ...
    <div className="max-w-6xl mx-auto font-sans pb-20">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative"><span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground text-sm">$</span><input type="text" placeholder="0.00" className="w-full pl-8 pr-4 py-3 bg-card border border-border rounded-xl text-sm focus:outline-none focus:border-primary-dark" /></div>
                  <p className="text-[10px] text-muted-foreground mt-2">Leave empty for no sale</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-card p-8 rounded-2xl shadow-sm border border-border">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input type="text" placeholder="The Story Behind This Treasure" className="w-full px-4 py-3 bg-card border border-border rounded-xl text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary-dark transition-all" />
              </div>
              <div>
                <label className="block text-xs font-bold text-foreground mb-2">Story Content <span className="text-destructive">*</span></label>
                <textarea rows={5} placeholder="This beautiful rose gold bracelet is the result of..." className="w-full px-4 py-3 bg-card border border-border rounded-xl text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary-dark transition-all resize-none" />
                <p className="text-[10px] text-muted-foreground mt-2 text-right">Minimum 50 characters recommended</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card p-8 rounded-2xl shadow-sm border border-border">
            ...
            <div className="space-y-6">
              <div>
                ...
                <textarea rows={4} placeholder="Every piece I create is infused with love..." className="w-full px-4 py-3 bg-card border border-border rounded-xl text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary-dark transition-all resize-none" />
                <p className="text-[10px] text-muted-foreground mt-2 text-right">Minimum 50 characters recommended</p>
              </div>
              <div>
                <label className="block text-xs font-bold text-foreground mb-2">Quote Author</label>
                <input type="text" placeholder="Sarah Anderson, Master Artisan" className="w-full px-4 py-3 bg-card border border-border rounded-xl text-sm text-foreground focus:outline-none focus:border-primary-dark transition-all" />
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card p-6 rounded-2xl shadow-sm border border-border mt-12">
          ...
          <div className="bg-card p-6 rounded-2xl shadow-sm border border-border">
            ...
            <button className="w-full py-4 border border-primary text-primary rounded-xl text-xs font-bold bg-card hover:bg-muted transition-all mb-3 shadow-sm shadow-pink-100 flex items-center justify-center gap-2">
              <Eye size={16} strokeWidth={2.5} /> Preview Story
            </button>
            <p className="text-[10px] text-muted-foreground text-center italic">See how your story will look on the product page</p>
          </div>
      ...
      <div className="w-full mt-6">
        <div className="bg-card p-8 rounded-2xl shadow-sm border border-border">
          ...
          <div className="w-full border-2 border-dashed border-border rounded-2xl py-12 flex flex-col items-center justify-center bg-muted">
            ...
            <button className="bg-primary text-primary-foreground px-6 py-2 rounded-lg text-xs font-bold shadow-sm shadow-pink-100 hover:bg-primary-dark transition-all">
              Choose Files
            </button>
          </div>
        ...
        <div className="flex gap-6 mt-12 justify-center">
          ...
          <button className="w-full max-w-xs py-4 bg-primary text-primary-foreground rounded-2xl text-sm font-bold shadow-lg shadow-pink-100 hover:bg-primary-darker transition-all">
            Publish Product
          </button>
        </div>
      </div>
