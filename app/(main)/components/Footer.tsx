          ...
          {isSubscribed ? (
            ...
            <>
              ...
              <form
                ...
                className="flex flex-row items-stretch mt-2 group focus-within:ring-2 focus-within:ring-pink-400 rounded-xl bg-transparent sm:bg-[#1E293B] border border-pink-300 overflow-hidden w-full max-w-sm"
              >
                <input
                  type="email"
                  required
