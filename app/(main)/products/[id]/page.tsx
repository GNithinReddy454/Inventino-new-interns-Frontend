    ...
    const fetchProduct = async () => {
      if (!productId || productId.length < 20) {
        setProduct({
          ...
          description:
            "Every piece we create carries a unique journey from concept to creation. This beautiful jewelry is the result of intricate craftsmanship. Each piece is individually inspected and polished by hand before being carefully packaged.",
          category: "EXCLUSIVE",
                ...
                <div className="p-6 pt-0 animate-in fade-in slide-in-from-top-2 flex flex-col gap-6">
                  ...
                  <button
                    onClick={() => {
                      ...
                      setTimeout(() => reviewsSectionRef.current?.scrollIntoView({ behavior: "smooth" }), 100);
                    }}
      ...
      <div className="bg-[#050505] py-16 md:py-32 px-4 relative">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:flex-1 bg-[#0F0F0F] rounded-3xl p-8 md:p-14 relative border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-10">
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-[65%] bg-[#D94F7A] rounded-r-full shadow-[0_0_15px_rgba(217,79,122,0.3)]" />
            <div className="pl-6 md:pl-10 space-y-6">
              <p className="text-white text-lg md:text-2xl italic font-medium leading-relaxed">
                "Every piece I create is infused with love and intention. I want the wearer to feel
                special and confident, knowing they're wearing something truly unique."
              </p>
              <div className="flex items-center gap-3">
