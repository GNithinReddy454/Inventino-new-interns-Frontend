  ...
  return (
    <div className="bg-[#fdf8f9] min-h-screen py-12 px-6 md:px-12 font-sans">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-serif text-gray-800 mb-2">Your Shopping Cart</h1>
        <p className="text-gray-400 text-sm mb-10">Review your items and proceed to checkout</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-pink-100 overflow-hidden">
              <div className="p-4 border-b border-gray-50 flex justify-between items-center bg-white">
                ...
                <span className="bg-pink-100 text-pink-600 text-xs px-2 py-1 rounded-full font-bold">{bag.length} Items</span>
              </div>
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex justify-end mt-2">
                      <div className="flex items-center border border-gray-100 rounded-full px-2 py-1 bg-white shadow-sm">
                        <button onClick={() => handleBag(item, -1)} className="p-1 text-gray-400 hover:text-pink-500"><Minus size={14}/></button>
                        <span className="font-bold text-gray-700 w-8 text-center text-sm">{item.quantity}</span>
                        <button onClick={() => handleBag(item, 1)} className="p-1 text-gray-400 hover:text-pink-500"><Plus size={14}/></button>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-pink-100 flex gap-4 shadow-sm">
              <input 
                ...
                className="flex-1 bg-white border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-pink-300"
              />
              <button className="bg-pink-500 text-white px-8 py-3 rounded-lg font-bold text-sm hover:bg-pink-600 transition-all">
                Apply Code
              </button>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-pink-100 shadow-sm sticky top-32">
              ...
              <div className="space-y-4 mb-6 border-b border-gray-50 pb-6 text-sm">
                ...
                <div className="flex justify-between text-gray-500 font-medium">
                  ...
                  <span className="text-gray-800 font-bold">${estimatedTax.toFixed(2)}</span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <Link href="/AllProducts" className="block w-full text-center border border-pink-200 text-pink-500 py-3 rounded-full font-bold text-sm hover:bg-pink-50 transition-all">
                  Continue Shopping
                </Link>
              </div>
              ...
              <div className="mt-8 space-y-3">
                ...
                <div className="flex items-center gap-3 text-[10px] text-gray-400 font-bold uppercase tracking-wide">
                  <Truck size={14} className="text-pink-500" /> Shipped with care and love
                </div>
                <div className="flex items-center gap-3 text-[10px] text-gray-400 font-bold uppercase tracking-wide">
                  <RotateCcw size={14} className="text-pink-500" /> 30-day returns policy
                </div>
              </div>
            </div>
          </div>
