...
export default function EditProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaveError(null);
    try {
      // Call PUT /users/me — only name & phone are supported by backend
      const res = await userService.updateProfile({
        name: form.fullName,
        phone: form.phone,
      });
      // Update local auth context with the returned data (+ any extra UI fields)
      updateUser({
        name: res?.data?.name || form.fullName,
                ...
                <div>
                  ...
                  <div className="dob-row">
                    {[
                      ...
                      >
                        <select
                          className={`input-select${!val ? " placeholder-active" : ""}`}
                          value={val}
                          onChange={(e) =>
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: "inherit",
                      boxShadow: "0 3px 10px rgba(217,79,122,0.25)",
