        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-foreground">100% Handmade</h3>
              <p className="text-muted-foreground">No mass production. Every single item is hand-stitched or hand-assembled by our skilled team.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-muted-foreground">We use only the finest materials to ensure your jewelry remains a keepsake for years to come.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-xl font-bold text-foreground">Ethical Sourcing</h3>
              <p className="text-muted-foreground">We prioritize sustainability and fair wages for all the artisans in our network.</p>
            </div>
          </div>
