        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-3">
              ...
              cherish should carry meaning, tell your story, and connect you to
              the artisan who made them.
            </p>
            <p className="text-sm text-gray-600 leading-relaxed mb-8">
              From the first sketch to the final polish, every step is a labor
              of love. We work with talented artisans who use traditional
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                >
                  <p className="text-2xl font-black text-pink-600 mb-1">
                    {stat.value}
                  </p>
