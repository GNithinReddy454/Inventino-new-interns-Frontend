    ...
    <section className="w-full bg-gradient-to-b from-white to-pink-50 px-4 md:px-6 lg:px-12 py-12 md:py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-10 md:mt-14">
          <ClientOnly>
            <button className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white px-10 py-3.5 rounded-full font-semibold transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95 uppercase tracking-wider text-sm">
